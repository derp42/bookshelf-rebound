        ...
        .then(function (method) {
          ...
          return this.triggerThen(
            ...
            .then(function (resp) {
              ...
              const hasStableIdentity = method === 'insert' || this.id != null;
              ...
              } else if (isObjectResponse && hasStableIdentity) {
                Object.assign(this.attributes, this.parse(resp[0]));
              }

              if (resp === 0 || resp.length === 0) return resp;
              if (isObjectResponse && hasStableIdentity) return this;
              if (options.autoRefresh === false) return this;
              if (method === 'update' && this.id == null) return this;
